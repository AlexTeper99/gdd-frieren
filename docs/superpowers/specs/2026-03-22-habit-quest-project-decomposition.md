...
| --- | --------------- | ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1.1 | **DevOps**      | ~~Vercel project + Vercel Postgres + Resend~~ | ✅ Done (2026-03-23) — Project deployed, Neon DB running, env vars in local and prod                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 1.2 | **DevOps**      | ~~Auth.js + magic links + proxy.ts~~          | ✅ Done (2026-03-23) — Functional login with 2 allowed emails, proxy.ts, DAL                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| 1.7 | **Copywriter**  | ~~Copy system & voice guide~~                     | ✅ Done (2026-03-24) — Complete copy system in `lib/copy/` (11 files), voice chart, glossary, 3 variants per string, voice guide tests (6 passing). Also covers copy for 3.9 (writing mechanic), 5.13 (co-op), 6.12 (arc + bond). Spec: `docs/superpowers/specs/2026-03-23-habit-quest-copy-design.md`                                                                                                                                                                                                         |
...
| 2.11 | **Copywriter**  | Copy integrated in components         | Copy already written in `lib/copy/` (task 1.7). This task is only integration: import copy constants into built components. Blocked on 2.7-2.9 (components must exist first).                                                                                                                                                                                                                                                   |
...
| 3.9 | **Copywriter**  | ~~Writing mechanic texts~~           | ✅ Done (1.7) — Copy in `lib/copy/writing.ts`. Integration-only when components exist.                                                                                                               |
...
| 5.13 | **Copywriter**  | ~~Co-op texts~~                           | ✅ Done (1.7) — Copy in `lib/copy/writing.ts` (turns), `lib/copy/sunday.ts` (pact, firma), `lib/copy/navigation.ts` (Nosotros), `lib/copy/onboarding.ts` (invite). Integration-only when components exist.                                                                                                                                                                                                  |
...
| 6.12 | **Copywriter**  | ~~Arc + bond texts~~                                | ✅ Done (1.7) — Copy in `lib/copy/navigation.ts` (arc close, deferred loading, tagline). Integration-only when components exist.                                            |
